...
const generate_SRL_memory_at_HL = () => { // eslint-disable-line camelcase
  const instruction = {};
  ...
  instruction.description = (
    <p>
      ...
      CY flag, and bit 7 of (HL) is reset to 0.
    </p>
  );
...
export default generate_SRL_memory_at_HL; // eslint-disable-line camelcase
