...
import { generate_LD_A_from_memory_at_HL_and_inc_HL } from './8-bit-transfer-and-io/LD_A_from_memory_at_HL_and_inc_HL';
...
export default [
  ...
  generate_LD_A_from_memory_at_HL_and_inc_HL
];
